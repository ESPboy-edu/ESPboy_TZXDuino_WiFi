...
void TZXPlay() {
  ...
  count = buffsize;                                //End of file buffer flush
  EndOfFile = false;
    ...
    switch (currentID) {
      ...
      case IDPAUSE:
        ...
        if (temppause > 0) {
          ...
          currentTask = GETID;
          if (EndOfFile == true) currentID = TEOF;
        }
        break;
...
void ReadTZXHeader() {
  ...
  unsigned char tzxHeader[11];
  int i = 0;

  if (entry.seek(0, SeekSet)) {
